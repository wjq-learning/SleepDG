...
dir_path = r'/data/datasets/sleep-edf-database-expanded-1.0.0/sleep-telemetry/'
...
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    with open(r'/data/datasets/t-sleep-edf-npy-filter/' + psg_f_name[3:6] + 'seq.npy', 'wb') as f:
        np.save(f, epochs_seq)
    with open(r'/data/datasets/t-sleep-edf-npy-filter/' + label_f_name[3:6] + 'label.npy', 'wb') as f:
